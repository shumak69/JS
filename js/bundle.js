...
function modal(formSelector) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', e => {
      ...
      form.insertAdjacentElement('afterend', statusMessage); //XMLHTTPREQUEST
      ...
      const formData = new FormData(form); //JSON
  ...
  function showThanksModal(message) {
    const prevModalDialog = document.querySelector('.modal__dialog'); // prevModalDialog.style.opacity = 0;
    ...
    setTimeout(() => {
      ...
      prevModalDialog.style.visibility = 'visible'; // prevModalDialog.style.display = 'block';
...
function slider(_ref) {
  ...
  const dotsWrapper = document.querySelector('.carousel-indicators'),
        clider = document.querySelector(slides);
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__["default"])('form');
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2022-03-9');
  (0,_modules_card__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_modules_calc__WEBPACK_IMPORTED_MODULE_5__["default"])(); // form();
